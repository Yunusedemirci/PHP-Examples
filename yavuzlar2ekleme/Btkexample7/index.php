<?php
try {
	$VeritabaniBaglantisi = new PDO("mysql:host=localhost;dbname=ornek7;charset=UTF8", "root", "");
...
<body>
	<table width="1000" align="center" border="0" cellpadding="0" cellspacing="0">
		...
		foreach ($SorguKayitlari as $Satirlar) {
			...
			?>
			<tr height="30" bgcolor="<?php echo $ArkaplanRengi; ?>" onMouseOver="this.bgColor='#c2cedb';"
				onMouseOut="this.bgColor='<?php echo $ArkaplanRengi; ?>';" style="cursor: pointer;">
				<td align="left">&nbsp;
					<?php echo $Satirlar["urunadi"]; ?>
				</td>
				<td align="right">
					<?php echo $Satirlar["ufunfiyati"]; ?>&nbsp;
				</td>
			</tr>
			<?php
			$RenkIcinSayi++;
