...
<body>
    ...
    if ($KayitSayisi > 0) {
        ...
        <table width="300" align="center" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr height="30">
                <td width="75">%
                    <?php echo $BirinciSecenekIcinYuzde; ?>
                </td>
                <td width="225">
                    <?php echo $Kayit["cevapbir"]; ?>
                </td>
            </tr>
            <tr height="30">
                <td width="75">%
                    <?php echo $IkinciSecenekIcinYuzde; ?>
                </td>
                <td width="225">
                    <?php echo $Kayit["cevapiki"]; ?>
                </td>
            </tr>
            <tr height="30">
                <td width="75">%
                    <?php echo $UcuncuSecenekIcinYuzde; ?>
                </td>
                <td width="225">
                    <?php echo $Kayit["cevapuc"]; ?>
                </td>
            </tr>
            <tr height="30">
                <td colspan="2" align="right"><a href="index.php" style="color: blue; text-decoration: none;">Ana Sayfaya
                        Dön</a></td>
            </tr>
            </form>
            <?php
